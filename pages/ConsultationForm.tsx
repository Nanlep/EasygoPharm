...
import { CalendarCheck, Clock, Phone, Mail, User as UserIcon, AlertCircle } from 'lucide-react';
...
export const ConsultationForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setErrorMsg(null);
    try {
      await StorageService.addConsultation(formData);
      setSubmitted(true);
    } catch (err: any) {
      ...
      <div className="min-h-[60vh] flex items-center justify-center bg-slate-50 px-4">
        <div className="bg-white p-8 rounded-3xl shadow-xl max-w-md w-full text-center border border-slate-100">
          ...
          <div className="bg-blue-50 p-4 rounded-xl text-xs text-blue-800 font-bold mb-8">
            Check your WhatsApp for confirmation details.
          </div>
